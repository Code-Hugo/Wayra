...
export function HotelCard({ hotel, index }: HotelCardProps) {
  return (
    <motion.div
      ...
      className="group"
    >
      <Card className="rounded-none border-none shadow-none overflow-hidden h-full flex flex-col">
        ...
        <CardFooter className="px-0 pt-0 mt-auto">
          <Button
            variant="outline"
            className="w-full rounded-full border-black/20 hover:border-black hover:bg-white text-black transition-all duration-200 transform active:scale-[0.98]"
          >
            Book this hotel
          </Button>
        </CardFooter>
